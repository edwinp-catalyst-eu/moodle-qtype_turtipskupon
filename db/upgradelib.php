...
/**
 * Upgrade library code for the turtipskupon question type.
 *
 * @package    qtype
...
/**
 * Class for converting attempt data for turtipskupon questions when upgrading
 * attempts to the new question engine.
 *
 * This class is used by the code in question/engine/upgrade/upgradelib.php.
 *
 */
class qtype_turtipskupon_qe2_attempt_updater extends question_qtype_attempt_updater {
    protected $order;

    public function is_blank_answer($state) {
        // blank turtipskupon answers are not empty strings, they rather end in a colon
