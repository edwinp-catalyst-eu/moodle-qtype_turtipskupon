...
require_once($CFG->dirroot . '/question/type/turtipskupon/questiontype.php');
 ...
 *
 */
class qtype_turtipskupon_test extends UnitTestCase {
    protected $qtype;

    public function setUp() {
        $this->qtype = new qtype_turtipskupon();
    }
    ...
    public function test_name() {
        $this->assertEqual($this->qtype->name(), 'turtipskupon');
    }
