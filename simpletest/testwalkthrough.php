 ...
 *
 * Note, there are already lots of tests of the turtipskupon type in the behaviour
 * tests. (Search for test_turtipskupon_question_maker::make_a_turtipskupon.) This file only
 ...
 *
 */
class qtype_turtipskupon_walkthrough_test extends qbehaviour_walkthrough_test_base {
    public function test_deferredfeedback_feedback_turtipskupon_single() {

        // Create a turtipskupon, single question.
    ...
    public function test_deferredfeedback_feedback_turtipskupon_multi() {
        // Create a turtipskupon, multi question.
