 ...
 * needed to restore one turtipskupon qtype plugin
 *
 */
class restore_qtype_turtipskupon_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        // Add own qtype stuff
        $elename = 'turtipskupon';
        // we used get_recommended_name() so this works
        $elepath = $this->get_pathfor('/turtipskupon');
    ...
    /**
     * Process the qtype/turtipskupon element
     */
    public function process_turtipskupon($data) {
        global $DB;
        ...
        if ($questioncreated) {
            ...
            // Insert record
            $newitemid = $DB->insert_record('question_turtipskupon', $data);
            // Create mapping (needed for decoding links)
            $this->set_mapping('question_turtipskupon', $oldid, $newitemid);
        }
    }
     ...
     * recoded pointing to all the restored stuff for turtipskupon questions
     *
    ...
    public static function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('question_turtipskupon',
                $fields, 'question_turtipskupon');
