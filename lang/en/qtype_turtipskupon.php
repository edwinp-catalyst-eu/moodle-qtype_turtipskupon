...
/**
 * Strings for component 'qtype_turtipskupon'
 *
 * @package    qtype
...
$string['pluginname'] = 'TUR Tipskupon';
$string['pluginname_help'] = 'In response to a question (that may include a image) the respondent chooses from multiple answers. There are two types of TUR Tipskupon questions - one answer and multiple answer.';
$string['pluginname_link'] = 'question/type/turtipskupon';
$string['pluginnameadding'] = 'Adding a TUR Tipskupon question';
$string['pluginnameediting'] = 'Editing a TUR Tipskupon question';
